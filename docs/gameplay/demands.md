...
- **Judged** — at the judgment election, each pledging party faces the reckoning (see [The hangover](#the-hangover)).
...
!!! note "You get at least two months to deliver"
...
!!! note "Elections are counted by date, as they actually run"
    "The next election" means the next one that *actually happens*, whichever chamber it's in. Call a [snap election](elections.md#early-elections) and you pull the whole timeline forward; a delayed election pushes it back (subject to the two-month delivery window above). If two chambers vote on the same day, that's one election event.
...
!!! tip "The boost doesn't stack — liability does"
...
!!! tip "The opposition's free lunch — and the one honest pledge"
