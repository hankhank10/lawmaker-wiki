...
|--------|------|-------------|
| **[Propose Law](legislation.md)** | **30 PP** | Submit legislation for voting |
| **[Call Early Election](elections.md#early-elections)** | **30 PP** | Trigger special election (10 PP if no parties have seats) |
...
1. **Proposing important laws** (30 PP)
   - Defines your legislative agenda
   - High visibility
   - Long-term impact

2. **Recruiting key activists** (10 PP)
   - Builds your team
   - Enables cabinet appointments
   - Long-term investment

#### Medium Priority (Strategic Actions)

3. **Commissioning polls** (10 PP)
   - Tracks electoral position
   - Informs strategy
   - Useful but not critical

4. **Calling early elections** (30 PP)
   - Only when you have clear advantage
   - High-risk, high-reward
   - Situational

#### Low Priority (Rare Actions)

5. **Expelling characters** (25 PP)
   - Only when necessary
...
=== "Conservative Approach"
    **Save PP for opportunities**
    ...
    ✓ Always have reserves for urgent proposals
    ✓ Can react to changing situations
    ✓ Never resource-starved
    ✗ May miss opportunities
    ✗ Wastes generation if capped at 120

=== "Active Approach"
    **Spend PP regularly**

    ✓ Maximize actions per day
    ✓ Stay active in legislation
    ✓ Build larger activist roster
    ✗ No reserves for emergencies
    ✗ Can't react to surprises

=== "Balanced Approach"
    **Maintain 30-60 PP reserve**

    ✓ Can propose law when needed
    ✓ Use most of generated PP
...
1. **Plan proposals carefully**
   - 30 PP is expensive
   - Don't waste on doomed proposals
   - Build coalition support first

2. **Recruit strategically**
   - Focus on high-trait activists
   - Quality over quantity
   - 3 great activists > 10 mediocre ones

3. **Poll before spending**
   - 10 PP poll can prevent wasting 30 PP on bad proposal
   - Check electoral position before calling early election

4. **Use free actions**
   - Vote on everything (free)
   - Communicate extensively (free)
   - Build coalitions through messaging (free)
...
- [Legislation & Voting](legislation.md) - Use PP to propose laws
- [Characters & Activists](characters.md) - Recruit with PP
- [Elections & Voters](elections.md) - Commission polls, call elections
- [Communication](communication.md) - Free coalition building
- [Strategy Guide](../strategy-guide.md) - Advanced resource management
