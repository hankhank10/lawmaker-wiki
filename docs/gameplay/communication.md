...
!!! example "Coalition Message"
    ...
    Our recent election results show:
    - Green Party: 230 seats (35%)
    - Social Democrats: 180 seats (28%)
    - Together: 410/650 seats (63%)

    I propose a coalition with this cabinet distribution:
    ...
    We'd commit to:
    - Universal healthcare expansion (your priority)
    - Green energy transition (our priority)
    - Progressive taxation (shared goal)
...
- [Poll results](elections.md#polling) (if public)
- Electoral analysis
...
!!! example "Information Message"
    ...
    I commissioned a public poll (see attached). Results show:
    - Left-wing parties: 52% combined
    - Right-wing parties: 48% combined
...
Each [proposal](legislation.md) has a **comment thread**:
