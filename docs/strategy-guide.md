...
Study the [elector system](gameplay/elections.md#understanding-voters):
...
**Action:** Commission [polls](gameplay/elections.md#polling) regularly to track your standing.
...
- 🔨 Workers' rights: +0.8
- 🛡️ Welfare state: +0.9
- ☮️ Diplomatic solutions: +0.7
- 🌍 Open immigration: +0.6
...
- ⛪ Religious governance: +0.6
- ⚔️ Military strength: +0.7
- 🚫 Border security: +0.8
...
- 🌍 Open immigration: +0.5
- 🏛️ Secular governance: +0.7
- 👮‍♂️ Law and order: -0.5 (reform focus)
...
- 🔨 Workers' rights: +1.0
- 🛡️ Welfare state: +1.0
- 🙋‍♀️ Gender equality: +0.8
- 📚 Education investment: +1.0
- 👶 Support young people: +0.9
...
2. **Message potential supporters** - Use [communication](gameplay/communication.md)
...
1. **Form government** - Lead [cabinet formation](gameplay/cabinet.md) if largest party
2. **Recruit characters** - Build [activist roster](gameplay/characters.md) for cabinet
